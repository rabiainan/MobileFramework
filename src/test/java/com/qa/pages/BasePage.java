...
public class BasePage {
    ...
    //Open the url with webDriver in browser //

    public void getURL () {
        String url=props.getProperty("url");
        myWebDriver.get().get(url);

    }

    // We can use this method for stale element //
    ...
    // We can use method for long waiting time for exc. "cold sync" //
    public void waitForVisibility_longTime(WebElement e) {
